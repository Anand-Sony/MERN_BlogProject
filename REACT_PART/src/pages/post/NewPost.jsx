...
const NewPost = ()=>{
    ...
    useEffect(()=>{
        const getCategories = async ()=>{
            try{
                const response = await axios.get(`/category?size=15`);  //size =1000 means 1000 users will show in the category
    ...
    const handleFileChange = async (e)=>{
        ...
        if(type === "image/png" || type === "image/jpg" || type === "image/jpeg"){
            ...
            setExtensionError("only .png or .jpg or .jpeg file are allowed");
        }
    }
            ...
            <div className="form-container" >
                <form className="inner-container" onSubmit={handleSubmit} >
                    ...
                    <div className="form-group" >
                        ...
                        <textarea className="form-control" type="text" name="desc" placeholder="Write a short description here " value={formData.desc} onChange={handleChange}/>
                    </div>


                    <div className="form-group" >
                        <label > Select an image </label>
                        <input className="form-control" type="file" name="file" placeholder=" Select file " onChange={handleFileChange}/>
